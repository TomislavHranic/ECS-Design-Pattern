...
export default class Scene {
  ...
  init() {
    ...
    let block = this.entityManager.addBlock(5*16, 190);
    this.mapEntitiesToSystems(block, ['sRender', 'sSpritesheetAnimation', 'sCollisionDetection']);
    block = this.entityManager.addBlock(6*16, 190);
    this.mapEntitiesToSystems(block, ['sRender', 'sSpritesheetAnimation', 'sCollisionDetection']);
    block = this.entityManager.addBlock(7*16, 190);
    this.mapEntitiesToSystems(block, ['sRender', 'sSpritesheetAnimation', 'sCollisionDetection']);
    block = this.entityManager.addBlock(8*16, 190);
    this.mapEntitiesToSystems(block, ['sRender', 'sSpritesheetAnimation', 'sCollisionDetection']);
    block = this.entityManager.addBlock(9*16, 190);
    this.mapEntitiesToSystems(block, ['sRender', 'sSpritesheetAnimation', 'sCollisionDetection']);
